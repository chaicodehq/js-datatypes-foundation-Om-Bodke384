...
export function createPaanOrder(basePaan, customizations) {
  ...
  const New_pan_order = Object.assign({}, basePaan, customizations)
  return New_pan_order
}
...
export function updatePrices(menu, increase) {
  ...
  const new_price_object = Object.entries(menu).map(([key,value])=>[key,value+increase])
  return Object.fromEntries(new_price_object)
}
...
export function mergeDailySpecials(regularMenu, specialsMenu) {
  ...
  const new_update_object = {...regularMenu,...specialsMenu}
