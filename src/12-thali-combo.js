...
const vegNonVeg = isVeg ? "Veg" : "Non-Veg"
const description = `${name.toUpperCase()} (${vegNonVeg}) - Items: ${items.join(", ")} - Rs.${price.toFixed(2)}`
return description
}
...
export function searchThaliMenu(thalis, query) {
  ...
  const matchedThalis = thalis.filter(thali => {
